...
;;
;; 2. Make sure to discuss work habits and any questions on the reading.
;;
;; 3. Make sure to upload this file as `strings.scm`.
;;
;; 4. Optional: Review the Q&A.
...
;; to `make-string`, one a call to `string`, and one a call to 
;; `list->string`.
...
;; b. Enter the expressions in Scamper's interactions pane (REPL) and check
;; your result.

;; ENTER THE VALUE OF `like` HERE

;; c. Write a procedure that does the same thing as this definition.
;; (That is, write a procedure, `like-person`, that takes a person and 
;; an adjective as inputs and produces a string that describes the person.

(define like-sentence
  ???)

;; d. Write another "template sentence" procedure of your own design. Make sure 
;; to take at least two parameters.
...
;; 
;; a. Make sure you've put your names, your section, and the date at the
;; top of the file.
;;
;; b. Save the file to disk. Make sure this file is named `strings.scm`.
;;
