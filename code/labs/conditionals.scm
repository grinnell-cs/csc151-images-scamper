...
;;; (rgb-brightness c) -> number? (between 0 and 100)
;;;   c : rgb?
...
;; You need not check that the input is an integer. If given a non-integer
;; input, your procedure can fail.
...
;; Your procedure should return false when `n` is real number,
;; a string, an image, a color, and, well, anything that's not 
;; an integer.
...
;;; c. Write a function (decimal-number? n) that returns true if `n`
;;; is a number that includes a decimal portion and false otherwise.
...
;; Spend no more than two minutes on this part of the problem.
...
;; b. Put your names at the top of the file.
;; c. Rename this file to `conditionals.scm` 
;;    name).
...
;; one or more of these exercises (after you submit).
...
;; Experiment with `better-even?` on a variety of examples to gain
...
;; REPLACE WITH YOUR CODE AND EXPLANATION 
