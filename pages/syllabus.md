...
* [**Disclaimers, advice, and more**](#disclaimers-advice-and-more). Additional thoughts on the course and your experience in the course.
  ...
  * [_**Class recordings**_](#class-recordings). I record and auto-transcribe each class section and post them to Teams.
  * [_**Names**_](#names). I get names wrong, even my kids' names. Please be sympathetic.
  * [_**Sam's hearing loss**_](#sams-hearing-loss). I'm losing my hearing. Please be sympathetic.
  * [_**Teaching is performative**_](#teaching-is-performative). I hope you enjoy the performances.
...
Following the principles of Universal Design, I make it a habit to record and live-transcribe our class sessions. The recordings should appear on our Teams "Recordings" channel. In particular, recordings can support students who might have had trouble understanding everything we covered and the transcriptions can help those who, like me, have some hearing loss. Others are also likely to find these recordings useful.

Please do not share recordings with those not in this semester's CSC-151. And please do not use the recordings as an excuse to miss class. (If you must miss class, the recording can serve as a partial replacement for the class experience, but it's not the same.)
...
I am losing my hearing. I use hearing aids, but they do not give me the same hearing as I once had. They are also very good at picking up the noise from the air handler. Please forgive me if I ask you to repeat yourself or to repeat what someone else said.
