---
title: "EBoard 11: Conditionals, Part 2"
number: 11
section: eboards
held: 2026-09-23
link: false
...
* As I mentioned in the course syllabus and email, I've turned in an 
  academic alert for anyone who has fewer than two LAs completed. 
...
* Additional times available for meetings this week.
    ...
    * Thursday: 8:00--10:00 a.m. and 4:30--5:00 p.m.
* Most of the mini-project 1 submissions have been graded. As soon as they 
  are all graded, I will release them to the class.
    * I'll demo how you look at your graded work.

### Notes on Mini-Project 1

* Mini-project 1 is available on Gradescope.
...
* Saturday, 25 September 2026, 2:00--3:30 p.m., Sebring-Lewis.
  _Grinnell Sympohony Orchestra Concert_ **New**
...
> Answer 1 :`and` returns `#f` if any of its parameters are `#f`. In `(and)`, none of the parameters are `#f`. Similarly, `or` returns `#t` if all of its parameters are `#t`. None of its parameters are `#t`.
