---
title: "EBoard 03: Writing Functions (Section 2)"
number: 3
section: eboards
held: 2026-09-01
link: true
...
* Don't forget that reading resonses are due the night before class!
...
* Friday, 4 September 2026, 4:10--5:00 p.m., HSSC N1170.
  _Middle of Everywhere_ (Algeria)
...
* Saturday, 5 September 2026, 1:00--4:00 p.m., Rosenbloom Field
...
* Running from 10:20--10:50
* If you are permitted (or just want) extra time, I'll stick around
  for thirty minutes after class.
    * You can also take one during our normal time and take the other
      at 7:30 a.m. or 4:00 p.m.
...
> I'm sorry. Those were the commnds from DrRacket. Now we just use
  `(import image)`.
...
Were we supposed to submit Monday's lab?
...
Some of the code in the readings doesn't work. Why not?

> Sam is incompetent?

> Scamper keeps changing.

> Please let me know when this happens.

Where should I submit my answers to readings?

> On Gradescope

When do Gradescope assignments get posted?

> Ideally, two days before they are due.

> Sometimes, when a student asks "Sam, where is the reading response on
  Gradescope?"
...
Don't forget that there's a fancy house in the reading.

Don't forget that there's a `(rotate angle-in-degrees image)` function.

If you finish early, do some of the extra problems.

It's also okay if you don't finish! Our labs tend to be too long.
