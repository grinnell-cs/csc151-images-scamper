...
* Running from 3:30--4:00 p.m. on Friday.
* If you are permitted (or just want) extra time, I'll stay here until 4:30.
    * You can also take one during our normal time and take the other
      at 11:00 a.m. or 7:30 a.m.
...
When you overlay and align, can you be more precise (e.g., using coordinates)?

> Yes, but I'm not sure how well those work right now.

> Use `overlay/offset`.

Why couldn't I type lambda on my laptop?

> Computers are evil. I'll look at it during lab.
